    ...
    <>
      ...
      <div dir='rtl' className='min-h-screen'>
        <div className='w-full flex justify-center my-10'>
          ...
          <input onKeyUp={(e)=>userSearch(e.currentTarget.value)} placeholder='ماذا تريد أن تقرأ  ؟' className={`w-3/4 rounded-pixel bg-primary2 active:outline-0 text-second border  hover:border-second ${main.className} mx-auto text-2xl px-10 py-2 focus:outline-0  focus:border-second  placeholder:text-second`}/>
        </div>
